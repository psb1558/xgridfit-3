...
# ygDefaults: Keeps defaults for this font's hints.
# ygcvt: Keeps the control values for this font.
# ygcvar: Keeps the cvar table.
# ygCalling: superclass for ygFunction and ygMacro.
# ygFunction(ygCalling): A function.
# ygMacro(ygCalling): A macro.
# ygPoint: One point.
...
# yamlTree: A tree for the YAML code.
# yamlNode: A node in a yamlTree.
...
# ygPointSorter: For sorting points on the x or y axis.
