...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
      ...
      information. Next is the global var area and finally a
      growable var frame area.
  -->
  ...
  <xsl:variable name="var-cv-cut-in" select="7"/>
  <xsl:variable name="var-cv-cut-in-default" select="8"/>
  ...
  <xsl:variable name="var-delta-sh" select="15"/>
  <xsl:variable name="var-delta-sh-default" select="16"/>
  <xsl:variable name="var-fn-stack-count" select="17"/>
  ...
  <!-- This number + 1 is the lowest address of a global var. -->
  <xsl:variable name="global-var-base" select="23"/>
  <!-- This number + 1 is the lowest address of a var
       in a gl program or fn. -->
  <xsl:variable name="var-frame-base"
                select="$global-var-base +
			count(/xgf:xgridfit/xgf:var)"/>
